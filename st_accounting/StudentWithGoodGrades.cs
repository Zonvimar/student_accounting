...
{
    public partial class StudentWithGoodGrades : Form
    {
        public StudentWithGoodGrades()
        {
            InitializeComponent();
            LoadReport();
        }
        ...
        {
            Student_Class.getStudentsWithGoodGrades();
        ...
        private void exportButton_Click(object sender, EventArgs e)
        {
            if (reportDataGridView.Rows.Count > 0)
            {
                ...
                if (saveFileDialog.ShowDialog() == DialogResult.OK)
                {
                    ...
                    string[] headers = { "Факультет", "Курс", "Группа", "ФИО студента" };
